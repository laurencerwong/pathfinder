...
{
    Swordsman *me = [[self alloc] initWithStats:s AndEquipment1:equipment1 AndEquipment2:equipment2 AndPlayerID:playerID AndColor:color];
...
+(int)SwordsmanWithRandStatsAndEquipment1:(Equipment *)equipment1 AndEquipment2:(Equipment *)equipment2 AndPlayerID:(int)playerID AndColor:(ccColor4F)color
{
    ...
    s.defense = 20 + arc4random() % 3;
    s.maxHealth = 150 + arc4random() %  50;
    s.speed = 8 + arc4random() %  3;
